<%@ Page Title="" Language="C#" MasterPageFile="~/ProductionLineLeader.master" AutoEventWireup="true" CodeFile="IncidentMaster.aspx.cs" Inherits="IncidentMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                               ...
                               <center><h1 class="style1">Incident Master</h1></center>
                                    
                                   <asp:Label ID="Label1" runat="server" Text="Incident ID:" ForeColor="Black"></asp:Label>
                                    <div class="form-group row">
                                    <asp:TextBox ID="txtID" runat="server" class="form-control form-control-user"  placeholder="Incident ID"></asp:TextBox>
                                    <asp:TextBox ID="txtStatus" runat="server" class="form-control form-control-user"  placeholder="Incident ID" Visible ="false"></asp:TextBox>   
                                    
                                    </div>
                                   
                                   
                                    
                                    <asp:Label ID="Label9" runat="server" Text="Incident Name:" 
                                    ForeColor="Black"></asp:Label>
                                    <div class="form-group row">
                                    <asp:TextBox ID="txtName" runat="server" class="form-control form-control-user"  placeholder="Incident Name"></asp:TextBox>
                    ...
                    <asp:ListItem Value="False">Deactivate</asp:ListItem>
                         ...
                         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" 
                                            DataKeyNames="Incidentid"  ForeColor="#333333" 
                                            GridLines="None" 
                             ...
                             <Columns>
                                 <asp:BoundField DataField="Incidentid" HeaderText="Incident_id" ReadOnly="True" 
                                     SortExpression="Incidentid" />
                                 <asp:BoundField DataField="Inm" HeaderText="Incident Name" 
                                     SortExpression="Inm" />
                             ...
                             <SortedDescendingHeaderStyle BackColor="#4870BE" />
                                    ...
                                    SelectCommand="SELECT * FROM [Incident_Master]">
                                </asp:SqlDataSource>
